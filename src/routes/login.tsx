...
function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // TODO: gọi API login thực tế, nhận lại role từ response
    // Hiện tại mock: email chứa "partner" → partner, còn lại → admin
    const isPartner = email.toLowerCase().includes('partner')

    if (isPartner) {
      localStorage.setItem('partner_token', 'mock-partner-token')
      navigate({ to: '/partner' })
    } else {
