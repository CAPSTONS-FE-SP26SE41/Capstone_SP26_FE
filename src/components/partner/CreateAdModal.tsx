          ...
          <form id="create-ad-form" onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-5">
                ...
                <div className="col-span-2">
                  <label className="block text-sm font-bold text-slate-700 mb-2">Mã POI (ID điểm tham quan) *</label>
                  <input required type="text" value={newAdForm.poiId} onChange={e => setNewAdForm({...newAdForm, poiId: e.target.value})} className="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-[#e28743]/10 focus:border-[#e28743] transition-all font-mono text-sm text-slate-600" placeholder="Nhập mã điểm tham quan của bạn" />
                </div>
                <div className="col-span-2">
